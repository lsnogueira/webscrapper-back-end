...
var listaValoresElement2: any = {"formResumoEmpresaCaged:lblCnpjRaiz":["formResumoEmpresaCaged:txtCnpjRaiz"],
"formResumoEmpresaCaged:lblRazaoSocial":["formResumoEmpresaCaged:txtRazaoSocial"], 

"formResumoEmpresaCaged:lblAtividadeEconomica":["formResumoEmpresaCaged:txtCodigoAtividadeEconomica", "formResumoEmpresaCaged:txtDescricaoAtividadeEconomica"], 
"formResumoEmpresaCaged:lblNumFiliais":["formResumoEmpresaCaged:txtNumFiliais"], 
"formResumoEmpresaCaged:lblTotalVinculos":["formResumoEmpresaCaged:txtTotalVinculos"]
, "formResumoEmpresaCaged:lblTotalNumPrimDia": ["formResumoEmpresaCaged:txtTotalNumPrimDia"]
,"formResumoEmpresaCaged:lblTotalNumAdmissoes": ["formResumoEmpresaCaged:txtTotalNumAdmissoes"]
,"formResumoEmpresaCaged:lblTotalNumDesligamentos":["formResumoEmpresaCaged:txtTotalNumDesligamentos"]
,"formResumoEmpresaCaged:lblTotalNumUltDia": ["formResumoEmpresaCaged:txtTotalNumUltDia"]
, "formResumoEmpresaCaged:lblTotalVariacaoAbosulta":["formResumoEmpresaCaged:txtTotalVariacaoAbosulta"]
...
async function irPaginaCaged(page: puppetteer.Page): Promise<any> {
    ...
    function limparTextoChave(textoChave: string): string{
        return textoChave.toLowerCase().replace(" de ","_").replace("-","").replace("/","_").replace("/","_").replace(" dos ","_").replace(" da ","_").replace(" do ","_").replace("ó","o")
        .replace(":","").replace("º", "").replace(" ", "_").replace("(s/n)", "")
    .replace("ç", "c").replace("ã", "a")
    }
    ...
    await page.waitForSelector('input[id="formPesquisarEmpresaCAGED:btConsultar"]')
    ...
    await page.waitForSelector("#formResumoEmpresaCaged\\:lblAtividadeEconomica")
    await page.waitForSelector("#formResumoEmpresaCaged\\:txtCodigoAtividadeEconomica")
    await page.waitForSelector("#formResumoEmpresaCaged\\:txtDescricaoAtividadeEconomica")
    ...
    await page.waitForSelector("#formResumoEmpresaCaged\\:lblTotalNumAdmissoes")
    await page.waitForSelector("#formResumoEmpresaCaged\\:txtTotalNumAdmissoes")
    await page.waitForSelector("#formResumoEmpresaCaged\\:lblTotalNumDesligamentos")
    await page.waitForSelector("#formResumoEmpresaCaged\\:txtTotalNumDesligamentos")
    ...
    await page.waitForSelector("#formResumoEmpresaCaged\\:lblTotalVariacaoAbosulta")
    await page.waitForSelector("#formResumoEmpresaCaged\\:txtTotalVariacaoAbosulta")
    ...
    const elementosJson2 = await page.evaluate((listaValoresElement2) => {
        ...
        function limparTextoChave(textoChave: string): string{
            return textoChave.toLowerCase().replace(" de ","_").replace("-","").replace("/","_").replace("/","_").replace(" dos ","_").replace(" da ","_").replace(" do ","_").replace("ó","o")
            .replace(":","").replace("º", "").replace(" ", "_").replace("(s/n)", "")
        .replace("ç", "c").replace("ã", "a").replace(" (cnae)","").replace("ê","e").replace("ú","u")
        .replace("í","i").replace("õ", "o").replace("ú", "u").replace("ô","o").replace("1_dia", "primeiro_dia")
        }
    ...
    await page.waitForSelector('input[id="formPesquisarTrabalhador:submitPesqTrab"]')
